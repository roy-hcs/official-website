...
export default function RrhHeader() {
  return (
    <>
      <div className="sticky top-0 left-0 z-[99] w-full flex justify-center bg-[linear-gradient(90deg,#4DEEFF_0%,#0DD1FC_11%,#0154FC_27%,#050818_66%)]">
      ...
      <div className="sticky top-[44px] left-0 z-[99] w-full flex justify-center h-17 py-4 bg-white/60 backdrop-blur-[31.3px]">
