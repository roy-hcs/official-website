...
export default function SubmitInfo({ onSuccess }: SubmitInfoProps) {
  ...
  return (
    <div className="bg-white">
      <div className="lg:px-[58px] lg:pb-[58px] p-0">
        <div className="mb-6">
          <span className="font-semibold lg:text-[36px] lg:leading-[1.2] text-[#020f2c] text-3xl  w-full px-3 leading-normal">
        ...
        <div>
          <span className="font-normal text-sm lg:leading-[1.6] text-[#656b8a]  w-full px-3 leading-normal">
            Ready to elevate your trading game? Fill out the form, and our team will get in touch with solutions tailored to
            your needs.
          </span>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div  className="lg:my-12 my-3">
              ...
              <div className="flex-1 lg:mb-12 mb-6">
                <div className="relative">
                  ...
                  />
                  {errors.firstName && (
                    <p className="text-red-500 text-xs mt-1 absolute">{errors.firstName.message}</p>
                  )}
                </div>
              </div>
              <div className="flex-1 lg:mb-12 mb-6">
                <div className="relative">
                  ...
                  />
                  {errors.lastName && (
                    <p className="text-red-500 text-xs mt-1 absolute">{errors.lastName.message}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="lg:flex gap-10 mb-12 block max-lg:mb-0">
              <div className="flex-1 lg:mb-12 mb-6">
                <div className="relative">
                  ...
                  />
                  {errors.phone && (
                    <p className="text-red-500 text-xs mt-1 absolute">{errors.phone.message}</p>
                  )}
                </div>
              </div>
              <div className="flex-1 lg:mb-12 mb-6">
            ...
            <div className="lg:mb-12 mb-6">
              <div className="relative">
                ...
                {errors.productInterest && (
                  <p className="text-red-500 text-xs mt-1 absolute">{errors.productInterest.message}</p>
                )}
              </div>
            </div>
            </div>
            ...
            >
              <span className="font-semibold text-base text-white leading-none">Send message</span>
            </button>
          </form>
      </div>
    </div>
