    ...
    >
      ...
      >
        <div className="px-5 pt-5 pb-2.5">
          {title && <span className="text-lg leading-6 text-[#303133]">{title}</span>}
          <button
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18 6L6 18M6 6L18 18" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </div>
        ...
        {footer && (
          <div className="px-5 pt-2.5 pb-5 text-right">
            {footer}
          </div>
        )}
      </div>
