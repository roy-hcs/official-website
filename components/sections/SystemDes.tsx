...
interface SystemDesProps {
  onOpen?: () => void;
}

export default function SystemDes({ onOpen }: SystemDesProps) {
  return (
    <div className="w-full bg-white lg:mb-[240px]">
      <ContainerWrap>
        ...
        <div className="lg:w-[710px] h-[52px] font-normal lg:text-lg text-[#020f2c] text-center mx-auto my-6 mb-12 text-xs w-full lg:px-0 px-3 lg:leading-6 leading-normal">
          Explore how our technology infrastructure supports your brokerage operations with seamless integrations across
          platforms.
        </div>
        <div 
          className="w-[146px] h-[52px] rounded-[14px] bg-[#020f2c] text-base font-semibold leading-[52px] text-white text-center mx-auto mb-6 cursor-pointer"
          onClick={onOpen}
        >
          Get A Demo
        </div>
